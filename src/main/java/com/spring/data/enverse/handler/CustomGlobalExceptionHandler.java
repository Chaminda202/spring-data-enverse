package com.spring.data.enverse.handler;

import com.spring.data.enverse.exception.EmployeeNotFoundException;
import com.spring.data.enverse.model.CustomErrorDTO;
...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> employeeNotFound(Exception ex, WebRequest request) {
